...
# เตรียม Phase 2
snarkjs powersoftau prepare phase2 pot12_0001.ptau prepared_pot12.ptau -v
# Setup zkey เริ่มต้น
snarkjs groth16 setup age_salary_check.r1cs prepared_pot12.ptau circuit_0000.zkey
# Contribute (ใส่ entropy)
snarkjs zkey contribute circuit_0000.zkey circuit_final.zkey --name="Final_Key" -v -e="random_entropy_123"
